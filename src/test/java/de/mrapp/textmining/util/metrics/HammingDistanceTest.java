...
public class HammingDistanceTest {
    ...
    public final void testEvaluate() {
        ...
        assertEquals(0, hammingDistance.evaluate("", ""));
        assertEquals(0, hammingDistance.evaluate("foo", "foo"));
        assertEquals(1, hammingDistance.evaluate("foo", "for"));
        assertEquals(3, hammingDistance.evaluate("foo", "bar"));
    }
    ...
    public final void testMinValue() {
        assertEquals(0, new HammingDistance().minValue());
    }

    @Test
    public final void testMaxValue() {
        assertEquals(Long.MAX_VALUE, new HammingDistance().maxValue());
    }
