...
abstract class AbstractTokenizer<TokenType : Token> : Tokenizer<TokenType> {
     ...
     * [position] is added to the existing token. A [tokenFactory] for converting the given [token]
     * to the type [T] must be provided.
     *
     ...
     */
    protected abstract fun onTokenize(text: String, map: MutableMap<String, TokenType>)
