 ...
 * Damerau-Levenshtein similarity always evaluates to heuristic values within the interval [0,1].
 * Texts that evaluate to greater heuristic values are considered to be more similar than texts that
 * evaluate to smaller heuristic values.
 *
 * @author Michael Rapp
 * @since 1.2.0
 */
public class DamerauLevenshteinSimilarity implements TextMetric {

    @Override
    public final double evaluate(@NotNull final String text1, @NotNull final String text2) {
        double damerauLevenshteinDissimilarity = new DamerauLevenshteinDissimilarity()
