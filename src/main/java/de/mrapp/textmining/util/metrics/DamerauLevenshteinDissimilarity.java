 ...
 * Damerau-Levenshtein dissimilarity always evaluates to heuristic values within the interval [0,1].
 ...
 * @since 1.2.0
 */
public class DamerauLevenshteinDissimilarity implements TextMetric {
